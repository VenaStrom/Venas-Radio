/*
  ...
  - You are about to drop the column `duration` on the `EpisodeProgress` table. All the data in the column will be lost.
...
INSERT INTO "new_EpisodeProgress" ("episode_id", "progress", "user_id") SELECT "episode_id", "progress", "user_id" FROM "EpisodeProgress";
