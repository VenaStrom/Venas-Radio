/*
  ...
  - You are about to drop the column `imageHD` on the `Episode` table. All the data in the column will be lost.
  - Added the required column `imageSquare` to the `Episode` table without a default value. This is not possible if the table is not empty.
  - Added the required column `imageWideHD` to the `Episode` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Episode" ("channelId", "description", "id", "programId", "publishDateUTC", "title") SELECT "channelId", "description", "id", "programId", "publishDateUTC", "title" FROM "Episode";
DROP TABLE "Episode";
