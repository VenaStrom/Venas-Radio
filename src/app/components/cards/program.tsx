...
export function ProgramCard({ program }: { program: Program }): React.ReactNode {
  return (
    <li className="w-full flex flex-row h-28 items-center justify-start">
      ...
      <img
        ...
        alt={`Programbild för ${program.name}`}
        fetchPriority="low"
      />
      ...
      <div className="h-full flex flex-col justify-start items-start gap-y-1 flex-1">
        <div className="flex flex-row justify-between items-center w-full">
          ...
          <div className="flex flex-row gap-x-4 items-center">
            ...
            {/* <PlayButton programId={program.id} /> */}
          </div>
        </div>
