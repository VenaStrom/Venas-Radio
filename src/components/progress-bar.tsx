 ...
 */
export default function ProgressBar({ progress, className, innerClassName }: { progress: number, className?: string, innerClassName?: string }) {
  ...
  const adjustedProgress = useMemo(() => progress ? offset + normalized : 0, [normalized, progress]);
